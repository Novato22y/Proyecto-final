...
// Evitar redeclaración cuando el archivo se carga varias veces (hot-reload / inclusión doble)
// Si `window.socialNetworks` ya existe, reutilizarlo; si no, inicializarlo.
if (typeof window.socialNetworks === 'undefined') {
...
function renderSocialIcons() {
  ...
  window.socialNetworks.slice(0, 4).forEach((net, i) => {
  ...
  window.socialNetworks.slice(4).forEach((net, i) => {
    const a = document.createElement('a');
